 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/org/pgj/jdbc/postgresql/fastpath/FastpathArg.java,v 1.1 2004-06-12 17:33:11 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
...
public class FastpathArg
{
	 ...
	 */
	protected void send(org.pgj.jdbc.postgresql.core.PGStream s) throws IOException
	{
		if (type)
		{
