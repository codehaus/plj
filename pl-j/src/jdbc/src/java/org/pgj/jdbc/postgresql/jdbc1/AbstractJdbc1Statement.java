...
/* $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/java/org/pgj/jdbc/postgresql/jdbc1/AbstractJdbc1Statement.java,v 1.1 2004-08-01 11:30:27 kocka Exp $
...
public abstract class AbstractJdbc1Statement implements BaseStatement
{
	...
	private String[] transformToCursorFetch() 
	{
		...
		if (org.pgj.jdbc.postgresql.Driver.logDebug)
			org.pgj.jdbc.postgresql.Driver.debug("using cursor based sql with cursor name " + m_cursorName);
	 ...
	 * <br>With org.pgj.jdbc.postgresql, this creates a large object, and stores the
