 ...
 *
 * PGbox.java
 *     This represents the box datatype within org.pgj.jdbc.postgresql.
 *
 * Copyright (c) 2003, PostgreSQL Global Development Group
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/java/org/pgj/jdbc/postgresql/geometric/PGbox.java,v 1.1 2004-08-01 11:30:27 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
...
public class PGbox extends PGobject implements Serializable, Cloneable
{
	...
	/*
	 * @return the PGbox in the syntax expected by org.pgj.jdbc.postgresql
	 */
