 ...
 *     extended by org.pgj.jdbc.postgresql.jdbc2.AbstractJdbc2Connection which adds 
 *     the jdbc2 methods.  The real Connection class (for jdbc1) is 
 *     org.pgj.jdbc.postgresql.jdbc1.Jdbc1Connection
 *
 * Copyright (c) 2003, PostgreSQL Global Development Group
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/java/org/pgj/jdbc/postgresql/jdbc1/AbstractJdbc1Connection.java,v 1.1 2004-08-01 11:30:27 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
...
//import org.pgj.jdbc.postgresql.core.PGStream;
import org.pgj.jdbc.postgresql.core.QueryExecutor;
//import org.pgj.jdbc.postgresql.core.StartupPacket;
...
public abstract class AbstractJdbc1Connection implements BaseConnection
{
	...
	// these properties are not needed, since there is no connnection information.
	...
	public void openConnection(String host, int port, Properties info, String database, String url, Driver d) throws SQLException
	  {
		...
		//no, user name is actualy ignored.
...
//		PG_STATUS = CONNECTION_OK;
	...
	/*
	 * Return the instance of org.pgj.jdbc.postgresql.Driver
	...
	{
		//TODO this should be the current database user.
		return "PLJ-DEFAULT";
	}
	 ...
	 * functions on the org.pgj.jdbc.postgresql backend itself.
	 *
	 ...
	 *
	 * <p><pre>
	 * import org.pgj.jdbc.postgresql.fastpath.*;
	 * ...
	 * Fastpath fp = ((org.pgj.jdbc.postgresql.Connection)myconn).getFastpathAPI();
	 * </pre>
	 *
	 * <p>where myconn is an open Connection to org.pgj.jdbc.postgresql.
	 *
	 * @return Fastpath object allowing access to functions on the org.pgj.jdbc.postgresql
	 * backend.
...
//	private Fastpath fastpath = null;
	 ...
	 *
	 * <p><pre>
	 * import org.pgj.jdbc.postgresql.largeobject.*;
	 * ...
	 * LargeObjectManager lo = ((org.pgj.jdbc.postgresql.Connection)myconn).getLargeObjectAPI();
	 * </pre>
	 *
	 * <p>where myconn is an open Connection to org.pgj.jdbc.postgresql.
	 *
	 ...
	 * org.pgj.jdbc.postgresql's more unique data types.
	 *
	 * <p>It uses an internal Hashtable to get the handling class. If the
	 * type is not supported, then an instance of org.pgj.jdbc.postgresql.util.PGobject
	 * is returned.
	 *
	...
	public Object getObject(String type, String value) throws SQLException
	{
		try
		{
			...
			// extends PGobject.
			//
			// This is used to implement the org.pgj.jdbc.postgresql unique types (like lseg,
			// point, etc).
	 ...
	 * <p><pre>
	 * ...
	 * ((org.pgj.jdbc.postgresql.Connection)myconn).addDataType("mytype","my.class.name");
	 * ...
	 * </pre>
	 *
	 * <p>where myconn is an open Connection to org.pgj.jdbc.postgresql.
	...
	//
	//TODO Hmmm, do we want to keep this?
	private static final String defaultObjectTypes[][] = {
				...
				{"money", "org.pgj.jdbc.postgresql.util.PGmoney"}
			};
...
//		this.autoCommit = autoCommit;
	...
	{
		//TODO this shoud return the current database name.
		return "PLJ-DEFAULT";
	}
...
//	}
	...
	/*
	 * This table holds the org.pgj.jdbc.postgresql names for the types supported.
	...
	public void addNotification(org.pgj.jdbc.postgresql.PGNotification p_notification)
	{
