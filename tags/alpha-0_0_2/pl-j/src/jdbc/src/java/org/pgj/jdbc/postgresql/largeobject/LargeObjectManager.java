 ...
 *      This class implements the large object interface to org.pgj.jdbc.postgresql.
 *
 ...
 *      org.pgj.jdbc.postgresql.largeobject.LargeObject is returned, and its methods
 *      then allow access to the object.
 *
 * Copyright (c) 2003, PostgreSQL Global Development Group
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/java/org/pgj/jdbc/postgresql/largeobject/LargeObjectManager.java,v 1.1 2004-08-01 11:30:27 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
package org.pgj.jdbc.postgresql.largeobject;
 ...
 * large objects from the database. When opening an object, an instance of
 * org.pgj.jdbc.postgresql.largeobject.LargeObject is returned, and its methods then allow
 * access to the object.
 *
 * <p>This class can only be created by org.pgj.jdbc.postgresql.Connection
 *
 ...
 *
 * lobj = ((org.pgj.jdbc.postgresql.PGConnection)myconn).getLargeObjectAPI();
 * </pre>
 *
 ...
 *
 * <p>Refer to org.pgj.jdbc.postgresql.largeobject.LargeObject on how to manipulate the
...
//	private Fastpath fp;
	 ...
	 * <br>This method should only be called by org.pgj.jdbc.postgresql.Connection
	 *
	 * <p>There should only be one LargeObjectManager per Connection. The
	 * org.pgj.jdbc.postgresql.Connection class keeps track of the various extension API's
