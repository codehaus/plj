 ...
 *
 * PGcircle.java
 *     This represents org.pgj.jdbc.postgresql's circle datatype, consisting of a point
 *     and a radius
 *
 * Copyright (c) 2003, PostgreSQL Global Development Group
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/java/org/pgj/jdbc/postgresql/geometric/PGcircle.java,v 1.1 2004-08-01 11:30:27 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
...
public class PGcircle extends PGobject implements Serializable, Cloneable
{
	...
	/*
	 * @return the PGcircle in the syntax expected by org.pgj.jdbc.postgresql
	 */
