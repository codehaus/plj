...
public abstract class AbstractJdbc3Clob extends org.pgj.jdbc.postgresql.jdbc2.AbstractJdbc2Clob
{

	public AbstractJdbc3Clob(org.pgj.jdbc.postgresql.PGConnection conn, int oid) throws SQLException
	{
		super(conn, oid);
	}
