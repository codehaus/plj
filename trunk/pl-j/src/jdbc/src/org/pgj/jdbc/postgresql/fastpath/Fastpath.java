 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/org/pgj/jdbc/postgresql/fastpath/Fastpath.java,v 1.1 2004-06-12 17:33:11 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
package org.pgj.jdbc.postgresql.fastpath;
 ...
 * This class implements the Fastpath api.
 *
 * <p>This is a means of executing functions imbeded in the org.pgj.jdbc.postgresql
...
public class Fastpath
{
			...
			while (!l_endQuery)
			{
				...
				switch (c)
				{
					case 'A':	// Asynchronous Notify
						...
						conn.addNotification(new org.pgj.jdbc.postgresql.core.Notification(msg, pid));
						break;
						//------------------------------
	 ...
	 *
	 * For an example of how this works, refer to org.pgj.jdbc.postgresql.largeobject.LargeObject
	 *
	 ...
	 * occurs.
	 * @see org.pgj.jdbc.postgresql.largeobject.LargeObject
	 */
	 ...
	 *
	 * <p>The org.pgj.jdbc.postgresql.largeobject.LargeObject class performs a query upon it's startup,
