 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/projects/plj/scm-cvs/pl-j/src/jdbc/src/org/pgj/jdbc/postgresql/core/QueryExecutor.java,v 1.1 2004-06-20 20:51:42 kocka Exp $
 *
 *-------------------------------------------------------------------------
 */
			...
			while (!l_endQuery)
			{
				...
				switch (c)
				{
					case 'A':	// Asynchronous Notify
						...
						connection.addNotification(new org.pgj.jdbc.postgresql.core.Notification(msg, pid));
						break;
