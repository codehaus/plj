...
public class PGJJDBCStatement implements Statement {
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		...
		try {
			...
			throw new SQLException("Comminication exception. root reason:"+e.getMessage());
		}
	...
	/**
	 * Checks if the statement is closed ot not. Throws an exception if so, returns if not.
	 */
